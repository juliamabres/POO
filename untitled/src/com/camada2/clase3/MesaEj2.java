        ...
        static int cualGana() {
            ...
            while (!(jugada1.equals("*")) || !(jugada2.equals("*"))) {
                ...
                if ((jugada1.equals("piedra") && jugada2.equals("papel")) ||
                        ...
                        (jugada1.equals("tijera") && jugada2.equals("Spock")) ||
                        (jugada1.equals("piedra") && jugada2.equals("Spock")) ||
                        (jugada1.equals("Spock") && jugada2.equals("papel"))
                ) {
                    contador2++;
                        ...
                        (jugada2.equals("tijera") && jugada1.equals("Spock")) ||
                        (jugada2.equals("piedra") && jugada1.equals("Spock")) ||
                        (jugada2.equals("Spock") && jugada1.equals("papel"))
                ) {
                    contador1++;
